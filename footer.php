...
<script src="<?php echo get_template_directory_uri(); ?>/assets/js/amazeui.min.js"></script>
<script src="<?php echo get_template_directory_uri(); ?>/assets/js/amazeui.swiper.min.js"></script>
<script>
	$(function() {
	$('#demo16').swiper({
